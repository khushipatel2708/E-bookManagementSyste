                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="city" id="city" class="form-control" required>
                                        <%
                                            CityDAO cityDAO = new CityDAO(DBConnect.getConnection());
                                            List<City> cities = cityDAO.getAllCities();

                                            int selectedCityId = -1;
                                            if (sd != null) {
                                                selectedCityId = sd.getCity();
                                            }

                                            for (City c : cities) {
                                                String selected = (c.getId() == selectedCityId) ? "selected" : "";
                                        %>
