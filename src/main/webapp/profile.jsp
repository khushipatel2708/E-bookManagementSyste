...
<head>
    ...
    <style>
        ...
        .profile-header { text-align:center; margin:40px 0 30px; }
        .profile-header h2 { font-weight:700; color:#0077b6; }
        .profile-header p { color:#6c757d; }
        .card-link-a { text-decoration:none!important; }
        .card-custom {
            background:#fff; border-radius:16px; border:none;
            box-shadow:0 4px 12px rgba(0,0,0,.08);
            transition:all .3s ease-in-out; height:100%;
        }
        .card-custom:hover {
        ...
        .card-custom:hover .card-body i { transform:scale(1.15) rotate(-5deg); }
        .card-custom h4 { font-weight:600; margin-bottom:8px; }
        .divider { width:50px; height:3px; margin:0 auto; border-radius:2px; }
        .text-primary .divider { background:#007bff; }
        .text-success .divider { background:#28a745; }
        .text-info .divider { background:#17a2b8; }
        .text-warning .divider { background:#ffc107; }
        .text-danger .divider { background:#dc3545; }
    </style>
</head>
<body>
    ...
    <div class="container profile-header">
        <h2>👤 My Profile</h2>
        <p>Welcome, <strong><%= displayName %></strong> — manage your account, orders, and preferences</p>
    </div>
