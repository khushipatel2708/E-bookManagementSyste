...
<head>
    ...
    <style>
        ...
        .password-card:hover {
            transform: translateY(-6px); box-shadow: 0 10px 25px rgba(0,0,0,0.15);
        }
        .password-card h3 { font-weight: 700; color: #0077b6; margin-bottom: 15px; }
        .form-control {
            border-radius: 10px; border: 1px solid #ced4da; padding: 12px 14px;
            transition: all 0.3s ease;
        }
        .form-control:focus {
            border-color: #007bff; box-shadow: 0 0 6px rgba(0,123,255,0.4);
        }
        ...
        #status { display: none; font-size: 0.9rem; margin-top: 8px; }
    </style>
</head>
<body>
                    ...
                    <form id="changePassword" class="mt-3">
                        ...
                        <div class="mb-3">
                            <input class="form-control" type="password" minlength="6"
                                   placeholder="Old Password" id="oPassword" name="oPassword" required />
                        </div>
                        <div class="mb-3">
                            <input class="form-control" type="password" minlength="6"
                                   placeholder="New Password" id="nPassword" name="nPassword" required />
                        </div>
                        <div class="mb-3">
                            <input class="form-control" type="password" minlength="6"
                                   placeholder="Confirm Password" id="cPassword" name="cPassword" required />
                        </div>
